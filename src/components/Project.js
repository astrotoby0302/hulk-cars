...
import Hulk2Img from '../style/images/h2-custom-icon-img-1.png';
...
const Project = () => {
    ...
    const Projects = [
        {avartar: require('../style/images/h1-custom-icon-img-1.png'), title: 'Hulk Token', desc: 'Hulk token allows you to be an investor in the company Hulk company via tokenization because part of the profits will be injected into the token via the buyback'},
        ...
        <Container id="ProjectSection">
            ...
            <Row className="car-rental mt-5">
                ...
                <Col lg={4} md={4} sm={12} xs={12} className="d-flex justifyf-content-center align-items-end logo">
                    <Flip>
                        <img src={Hulk2Img} alt="" width="400" height="400" />
                    </Flip>
                </Col>
            </Row>
            <Row className="tokenized-car mt-5">
                <Col lg={7} md={7} sm={7} xs={12} className="d-flex justify-content-center align-items-center logo">
                    <Slide>
                        <img src={CarSkeletonImg} alt="" width="667" height="393" />
                    </Slide>
                </Col>
